...
async def get_license_settings(
    ...
    return schemas.LicenseStatusResponse(
        ...
        schedules_enabled=license_status.schedules_enabled,
        detection_as_code_enabled=license_status.detection_as_code_enabled,
        reports_enabled=license_status.reports_enabled,
        audit_retention_days=license_status.audit_retention_days,
        daily_test_run_limit=license_status.daily_test_run_limit,
