...
/**
 * Detection Sources settings page.
 *
 ...
 * local edits become proposals routed through the /proposals inbox
 * (Sprint 2 approval UI).
 *
 * UX shape
 * --------
 * * Primary: a list of configured sources, each with the last sync
 *   status + counts and a one-click "Sync now" action.
 * * Secondary: "Add source" opens a dialog with the minimum viable set
 *   of config fields (url, branch, path_glob, auth type + token).
 * * Tertiary: delete and the result-summary line appearing right after
 *   a sync completes.
 *
 ...
 */
export default function DetectionSourcesPage() {
